...
void MBO_Object::MBO()
{
	...
	int nEvaluations = ag.size();

	// Begin the optimization loop
	while (nEvaluations <= MaxFEs)
	{
		// Elitism strategy
		...
		// Update Function Evaluations (FEs)
		nEvaluations = nEvaluations + ag.size();
...
void MBO_Object::output()
{
	...
	cout << "dimension=" << dim << ", ";
	cout <<  "maximum generation= " << maxGen << endl;
	cout << "maximum function evaluations (FEs)=" << MaxFEs << endl;
